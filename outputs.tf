output "servicebus_namespace_customer_managed_keys_id" {
  ...
  value       = { for k, v in azurerm_servicebus_namespace_customer_managed_key.servicebus_namespace_customer_managed_keys : k => v.id if v.id != null && length(v.id) > 0 }
}
output "servicebus_namespace_customer_managed_keys_infrastructure_encryption_enabled" {
  ...
  value       = { for k, v in azurerm_servicebus_namespace_customer_managed_key.servicebus_namespace_customer_managed_keys : k => v.infrastructure_encryption_enabled if v.infrastructure_encryption_enabled != null }
}
output "servicebus_namespace_customer_managed_keys_key_vault_key_id" {
  ...
  value       = { for k, v in azurerm_servicebus_namespace_customer_managed_key.servicebus_namespace_customer_managed_keys : k => v.key_vault_key_id if v.key_vault_key_id != null && length(v.key_vault_key_id) > 0 }
}
output "servicebus_namespace_customer_managed_keys_namespace_id" {
  ...
  value       = { for k, v in azurerm_servicebus_namespace_customer_managed_key.servicebus_namespace_customer_managed_keys : k => v.namespace_id if v.namespace_id != null && length(v.namespace_id) > 0 }
}
